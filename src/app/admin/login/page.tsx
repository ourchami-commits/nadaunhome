  ...
  return (
    <main className="min-h-screen bg-bg flex items-center justify-center px-4">
      <div className="bg-white rounded-3xl shadow-sm p-10 w-full max-w-sm">
        ...
        {error && <p className="text-secondary text-sm text-center mb-4 break-all">{error}</p>}

        <button
          onClick={handleGoogleLogin}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 border border-border bg-white hover:bg-bg disabled:opacity-60 text-dark font-semibold py-3 rounded-full transition-colors"
        >
